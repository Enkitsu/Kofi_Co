...
public class coldnoncoffee_IcedChocolateMilk extends JFrame {
	...
	public coldnoncoffee_IcedChocolateMilk() {
		mainFrame();
		mainPanel();
		frame.add(mainPanel);
		frame.pack();
	...
	public void BottomHeader() {
		...
		ActionListener proceedAction = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				StringBuilder orderName = new StringBuilder("Iced Chocolate Milk");
	...
	public void setupAddOnPanel() {
		...
		String [] sizePrice = {"70.00", "80.00", "90.00"};
        ...
        milkOptPanel.add(setupOptionsPanel(2, 3, 185, 40, 400, 4, milkIMG, milkOption, milkPrice));
		...
		String [] toppingIMG = {"", "", ""};
		String [] toppingOption = {"Whipped Cream", "Chocolate Drizzler", "Cocoa Powder"};
		String [] toppingPrice = {"15.00", "15.00", "15.00"};
		
		toppingOptPanel.add(setupOptionsPanel(1, 3, 165, 40, 520, 3, toppingIMG, toppingOption, toppingPrice));
				...
				public void actionPerformed(ActionEvent e) {
					if (hasLabelP) {
						...
						if (Arrays.asList("Small", "Medium", "Large").contains(labelB)) {
							selectedSize = labelB;
						} else if (Arrays.asList("Whipped Cream", "Chocolate Drizzler", "Cocoa Powder").contains(labelB)) {
	...
	public void setupDescription() {
		name = "<html><p style='text-align: center;'>Iced Chocolate Milk</p></html>";
		desc = "<html><p style='width: 450px; text-align: center;'>A delightful blend of rich chocolate and cold milk, " +
			   "perfect for chocolate lovers. Customize with your choice of milk options and toppings for an extra special treat.</p></html>";
	}
	...
	public static void main(String[] args) {
		new coldnoncoffee_IcedChocolateMilk();
	}
