	            ...
	            public void actionPerformed(ActionEvent e) {
	                if (hasLabelP) {
	                    ...
	                    if (Arrays.asList("Small", "Medium", "Large").contains(labelB)) {
	                        ...
	                        selectedTemp = labelB;
	                    } else if (Arrays.asList("Crushed Oreo", "Whipped Cream", "Chocolate Chip", "Stick O").contains(labelB)) {
	                        selectedTopping = labelB;
	                    } else if (Arrays.asList("Vanilla", "Caramel", "Hazelnut", "Salted Caramel", "Chocolate").contains(labelB)) {
