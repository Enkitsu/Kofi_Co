...
public class frappe_CookiesnCream extends JFrame {
	...
	public void BottomHeader() {
		...
		ActionListener proceedAction = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				StringBuilder orderName = new StringBuilder("Cookies & Cream Frappe");
	...
	public void setupAddOnPanel() {
		...
		String[] toppingIMG = { "", "", "", "", "" };
		String[] toppingOption = { "Whipped Cream", "Chocolate Drizzle", "Cookie Crumbs", "Chocolate Chips",
				"Matcha Powder" };
		...
		String[] syrupIMG = { "", "", "", "", "" };
		String[] syrupsOption = { "None", "Vanilla", "Caramel", "Hazelnut", "Salted Caramel" };
				...
				public void actionPerformed(ActionEvent e) {
					if (hasLabelP) {
						...
						if (Arrays.asList("Small", "Medium", "Large").contains(labelB)) {
							...
							selectedMilk = labelB;
						} else if (Arrays.asList("Whipped Cream", "Chocolate Drizzle", "Cookie Crumbs",
								"Chocolate Chips", "Matcha Powder").contains(labelB)) {
							selectedTopping = labelB;
						} else if (Arrays.asList("None", "Vanilla", "Caramel", "Hazelnut", "Salted Caramel")
								.contains(labelB)) {
	...
	public void setupDescription() {
		name = "<html><p style='text-align: center;'>Cookies & Cream Frappe</p></html>";
		desc = "<html><p style='width: 450px; text-align: center;'>A delightful blend of crushed cookies and cream "
				+ "with our signature frappe base, topped with whipped cream and cookie crumbs. "
				+ "The perfect indulgent treat that combines the rich taste of cookies with "
				+ "the smooth, creamy texture of a frappe.</p></html>";
	}
