...
public class icedcoffee_Mocha extends JFrame {
	...
	public void BottomHeader() {
		...
		ActionListener proceedAction = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				StringBuilder orderName = new StringBuilder("Iced Mocha");
	...
	public void setupDescription() {
		name = "<html><p style='text-align: center;'>Iced Mocha</p></html>";
		desc = "<html><p style='width: 450px; text-align: center;'>A perfect blend of rich espresso, "
				+ "chocolate sauce, and cold milk over ice, topped with your choice of drizzle "
				+ "for a decadent coffee experience.</p></html>";
	}
