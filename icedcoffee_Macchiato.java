...
public class icedcoffee_Macchiato extends JFrame {
	...
	public void BottomHeader() {
		...
		ActionListener proceedAction = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				StringBuilder orderName = new StringBuilder("Iced Macchiato");
	...
	public void setupDescription() {
		name = "<html><p style='text-align: center;'>Iced Macchiato</p></html>";
		desc = "<html><p style='width: 450px; text-align: center;'>A sophisticated blend of espresso "
				+ "and milk, layered to create a beautiful marbled effect, customizable with your "
				+ "choice of syrups and toppings.</p></html>";
	}
