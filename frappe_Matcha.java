...
public class frappe_Matcha extends JFrame {
	...
	public void BottomHeader() {
		...
		ActionListener proceedAction = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				StringBuilder orderName = new StringBuilder("Matcha Frappe");
	...
	public double calculateSingleItemPrice() {
		...
		price += 130.0; // Base price
		
		if (selectedSize.equals("Large")) price += 20.0;
		else if (selectedSize.equals("Medium")) price += 10.0;
		
		if (!selectedSyrup.isEmpty() && !selectedSyrup.equals("None")) price += 10.0;
		if (!selectedTopping.isEmpty() && !selectedTopping.equals("None")) price += 15.0;
	...
	public void setupAddOnPanel() {
		...
		String [] sizePrice = {"130.00", "140.00", "150.00"};
		...
		String [] toppingIMG = {"", "", "", "", ""};
		String [] toppingOption = {"Whipped Cream", "Red Bean", "Mochi", "Green Tea Kit Kat", "Extra Matcha Powder"};
		...
		String [] syrupIMG = {"", "", "", "", ""};
		String [] syrupsOption = {"None", "Vanilla", "Caramel", "Hazelnut", "White Chocolate"};
				...
				public void actionPerformed(ActionEvent e) {
					if (hasLabelP) {
						...
						if (Arrays.asList("Small", "Medium", "Large").contains(labelB)) {
							...
							selectedMilk = labelB;
						} else if (Arrays.asList("Whipped Cream", "Red Bean", "Mochi", "Green Tea Kit Kat", "Extra Matcha Powder").contains(labelB)) {
							selectedTopping = labelB;
						} else if (Arrays.asList("None", "Vanilla", "Caramel", "Hazelnut", "White Chocolate").contains(labelB)) {
	...
	public void setupDescription() {
		name = "<html><p style='text-align: center;'>Matcha</p></html>";
		desc = "<html><p style='width: 450px; text-align: center;'>A premium Japanese-inspired frappe made with "
				+ "high-grade matcha green tea powder, perfectly blended with milk and ice. "
				+ "Experience the authentic, rich flavor of matcha in this refreshing and "
				+ "energizing beverage.</p></html>";
	}
